...
Modified by Hunter Young on: 10/4/18
"""
import sys, os, csv
...
class Form(QMainWindow):
    ...
    def create_main_frame(self):
        ...
        self.load_button = QPushButton("&Load Collection")
        self.connect(self.load_button, SIGNAL('clicked()'), self.on_load)
        ...
        right_vbox.addWidget(self.load_button)
